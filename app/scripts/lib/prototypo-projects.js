(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		define("prototypo-projects", [], factory);
	else if(typeof exports === 'object')
		exports["prototypo-projects"] = factory();
	else
		root["prototypo-projects"] = factory();
...
var getPrototypoUser = function getPrototypoUser(userEmail) {
    return '\n        query {\n            User (\n                email: "' + userEmail + '"\n            ) {\n                id\n            }\n        }\n    ';
};
...
var getUserProjects = function getUserProjects(graphQLID) {
    return '\n    query {\n        User(\n            id: "' + graphQLID + '"\n        )\n        {\n            library {\n                name\n                id\n                template\n                variants {\n                    values\n                    name\n                    id\n                }\n            }\n        }\n    }\n';
};

var GRAPHQL_PROTOTYPO_API = 'https://api.graph.cool/simple/v1/prototypo';

var prototypoProjects = {
    getProjects: function getProjects(email, password) {
        var userPresetsPromise = new Promise(function (resolve, reject) {
            (0, _graphqlRequest.request)(GRAPHQL_PROTOTYPO_API, getPrototypoUser(email)).then(function (data) {
                var userID = data.User.id;

                (0, _graphqlRequest.request)(GRAPHQL_PROTOTYPO_API, authenticateUser(email, password)).then(function (res) {
                    var token = res.authenticateEmailUser.token;
                    var client = new _graphqlRequest.GraphQLClient(GRAPHQL_PROTOTYPO_API, {
                        headers: {
                            Authorization: 'Bearer ' + token
                        }
                    });

                    client.request(getUserProjects(userID)).then(function (fonts) {
...
exports.default = prototypoProjects;
...
//# sourceMappingURL=prototypo-projects.js.map